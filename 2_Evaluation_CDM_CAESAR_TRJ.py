...
# File paths for the CAESAR_TRJ XML files
file_paths = [
    "cdms/CAESAR_TRJ_1.xml",
    "cdms/CAESAR_TRJ_2.xml",
    "cdms/CAESAR_TRJ_3.xml",
    "cdms/CAESAR_TRJ_4.xml",
    "cdms/CAESAR_TRJ_5.xml",
    "cdms/CAESAR_TRJ_6.xml",
    "cdms/CAESAR_TRJ_7.xml",
    "cdms/CAESAR_TRJ_8.xml",
    "cdms/CAESAR_TRJ_9.xml",
    "cdms/CAESAR_TRJ_10.xml",
    "cdms/CAESAR_TRJ_11.xml",
    "cdms/CAESAR_TRJ_12.xml",
    "cdms/CAESAR_TRJ_13.xml",
    "cdms/CAESAR_TRJ_14.xml",
    "cdms/CAESAR_TRJ_15.xml",
    "cdms/CAESAR_TRJ_16.xml",
    "cdms/CAESAR_TRJ_17.xml",
]
...
output_file = "cdm_caesar_trj_results/caesar_trj_extracted_data.csv"
...
file_path = "cdm_caesar_trj_results/caesar_trj_extracted_data.csv"
...
stats.to_csv("key_statistics_caesar_trj.csv", index=True)
correlation.to_csv("correlation_analysis_caesar_trj.csv", index=True)
grouped_stats.to_csv("grouped_statistics_caesar_trj.csv", index=False)

# Display the key findings directly in the console
print("\n--- CAESAR_TRJ Key Statistics ---")
print(stats)

print("\n--- CAESAR_TRJ Correlation Analysis ---")
print(correlation)

print("\n--- CAESAR_TRJ Grouped Statistics by Object ---")
print(grouped_stats)
...
most_reliable.to_csv("most_reliable_entry_caesar_trj.csv", header=True)
