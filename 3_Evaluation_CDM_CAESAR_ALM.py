...
# File paths for the CAESAR_ALM XML files
file_paths = [
    "cdms/CAESAR_ALM_0.xml",
    "cdms/CAESAR_ALM_1.xml",
    "cdms/CAESAR_ALM_2.xml",
    "cdms/CAESAR_ALM_3.xml",
    "cdms/CAESAR_ALM_4.xml",
    "cdms/CAESAR_ALM_5.xml",
    "cdms/CAESAR_ALM_6.xml",
    "cdms/CAESAR_ALM_7.xml",
    "cdms/CAESAR_ALM_8.xml",
    "cdms/CAESAR_ALM_9.xml",
    "cdms/CAESAR_ALM_10.xml",
]
...
output_file = "cdm_caesar_alm_results/caesar_alm_extracted_data.csv"
...
file_path = "cdm_caesar_alm_results/caesar_alm_extracted_data.csv"
...
stats.to_csv("key_statistics_caesar_alm.csv", index=True)
correlation.to_csv("correlation_analysis_caesar_alm.csv", index=True)
grouped_stats.to_csv("grouped_statistics_caesar_alm.csv", index=False)

# Display the key findings directly in the console
print("\n--- CAESAR_ALM Key Statistics ---")
print(stats)

print("\n--- CAESAR_ALM Correlation Analysis ---")
print(correlation)

print("\n--- CAESAR_ALM Grouped Statistics by Object ---")
print(grouped_stats)
...
most_reliable.to_csv("most_reliable_entry_caesar_alm.csv", header=True)
